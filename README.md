...
!!!Gemini hariç hepsinin free versiyonu kullanıldı.
...
!!!Sadece "automated" kelimesi eklendi.
...
!!!Her seferinde yeni chat oluşturuldu, Parabank.json, example.json ve Parabank3.json dosyası kullanıldı.

!!!AŞAĞIDAKİ LİNKLER SIRASI İLE DENENMİŞTİR!!!
